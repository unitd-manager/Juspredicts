  ...
  return (
    <Dialog open={open} onOpenChange={(next) => !isPending && setOpen(next)}>
      <DialogTrigger asChild>
        <Button variant="secondary">Leave clan</Button>
      </DialogTrigger>
            ...
            <CardContent className="space-y-4">
              <div className="rounded-2xl border border-white/5 bg-white/5 p-4">
                ...
                <p className="text-2xl font-semibold text-white">
                  {getMemberName(topPerformer?.userInfo)}
                </p>
              ...
              <div className="rounded-2xl border border-white/5 bg-white/5 p-4">
                ...
                <p className="text-sm text-muted-foreground">Active participants in this clan</p>
              </div>
              <div className="rounded-2xl border border-white/5 bg-white/5 p-4">
                <p className="text-sm text-white/70">Last activity</p>
                <p className="text-lg text-white">{formatDate(activityQuery.data?.activities?.[0]?.eventStartDate)}</p>
              </div>
            </CardContent>
          </Card>
        </section>
