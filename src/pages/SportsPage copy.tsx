...
const EventDetails: React.FC<{ eventId: string; selectedQuestionId?: string | null; onBack: () => void; onPredict: (question: any, eventId: string, predictionId?: string | null) => void }> = ({ eventId, selectedQuestionId, onBack, onPredict }) => {
  const [event, setEvent] = React.useState<any | null>(null);
  const [questions, setQuestions] = React.useState<any[]>([]);
  const [isLoading, setIsLoading] = React.useState(true);
  const [tab, setTab] = React.useState< "Others" | "Live" | "Open" | "Completed" | "Cancelled" | "Exit">("Others");
